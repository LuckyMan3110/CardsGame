...
import { SignInInput, Navbar } from '../../../components';
            ...
            <div className="flex flex-wrap items-center min-h-screen">
                ...
                <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                        ...
                        {/* <div className="pt-4">
                            <button className="w-80 my-2 bg-meta-7 py-2 px-10 rounded-xl flex text-xl text-meta-9"><AiFillGoogleCircle className="text-3xl text-meta-9 mx-2"></AiFillGoogleCircle>Sign In With Google</button>
                            <button className="w-80 my-2 bg-meta-4 py-2 px-10 rounded-xl flex text-xl text-meta-9"><FiPhoneCall className="text-3xl text-meta-9 mx-2"></FiPhoneCall>Sign In With Phone</button>
                        </div> */}
                    </div>
                </div>
            </div>
