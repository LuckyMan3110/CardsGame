    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire({
          ...
          text: 'Anda telah Successful keluar.',
          icon: 'success',
          timer: 1500,
        ...
        >
          <span className='hidden lg:block'>
            <span className='block text-sm font-medium text-black dark:text-white'>
              {dataPegawai.user_name}
            </span>
            <span className='block text-xs'>{dataPegawai.access_type}</span>
          </span>
      ...
      {dropdownOpen && (
        ...
        >
          <ul className='flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark'>
            <li>
              <Link
                to={user?.access_type === 'admin' ? '/ubah-password' : '/ubah-password-pegawai'}
